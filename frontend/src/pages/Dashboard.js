        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 bg-gradient-to-r from-blue-100 to-purple-100 px-4 py-2 rounded-full">
                <User className="w-5 h-5 text-blue-600" />
                <div className="hidden sm:block">
                  <div className="text-sm font-semibold text-gray-900" data-testid="user-name">{user.name}</div>
                  <div className="text-xs text-gray-600">{user.city}</div>
                </div>
              </div>
              <Button
